    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="konfirmasitambahpenerbit" method="post">
        <div class="card-body">
          <div class="form-group row">
            <label for="tag" class="col-sm-3 col-form-label">Penerbit</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="tag" value="" name="penerbit">
            </div>
          </div>
          <div class="form-group row">
        ...
        <div class="card-footer">
          <div class="col-sm-10">
            <button type="submit" name="tambah" class="btn btn-info float-right"><i class="fas fa-plus"></i> Tambah</button>
          </div>  
        </div>
        <!-- /.card-footer -->
      </form>
